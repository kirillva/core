Ext.define('Core.profile.Phone', {
    ...
    //
    views: {
        email: 'Core.view.phone.email.Email',
        inbox: 'Core.view.phone.email.Inbox',
        compose: 'Core.view.phone.email.Compose',

        searchusers: 'Core.view.phone.search.Users'
    },
