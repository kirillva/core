...
Ext.define('Core.form.field.ClearButton', {
    ...
    addListeners: function () {
        ...
        textField.on('change', this.handleChange, this);
    ...
    destroy: function () {
        var textField = this.textField;
        var bodyEl = textField.bodyEl;
        bodyEl.un('mouseover', this.handleMouseOverInputField, this);
        bodyEl.un('mouseout', this.handleMouseOutOfInputField, this);

        // listeners on text field (component level)
        textField.un('destroy', this.handleDestroy, this);
        textField.un('resize', this.repositionClearButton, this);
        textField.un('change', this.handleChange, this);

        var clearButtonEl = this.clearButtonEl;
        clearButtonEl.un('mouseover', this.handleMouseOverClearButton, this);
        clearButtonEl.un('mouseout', this.handleMouseOutOfClearButton, this);
        clearButtonEl.un('mousedown', this.handleMouseDownOnClearButton, this);
        clearButtonEl.un('mouseup', this.handleMouseUpOnClearButton, this);
        clearButtonEl.un('click', this.handleMouseClickOnClearButton, this);
        this.handleDestroy();
        this.callParent(arguments);
    },
